...
export default function Footer() {
    ...
    return (
        !isAdminPage && (
            <footer className="flex flex-col self-stretch lg:px-20 max-sm:px-2 lg:pt-16 md:pt-10 pb-5 mt-16 w-full bg-white max-md:px-5 max-md:mt-10 max-md:max-w-full">
