...
import com.danhthanhf.distantclass.service.*;
...
//    publicApi ResponseEntity<ResponseObject> followComment(@PathVariable UUID commentId) {
//        var result = userService.followComment(commentId);
//        return ResponseEntity.status(result.getStatus()).body(result);
//    }
//
//    @PutMapping("/comments/{commentId}/un-follow")
//    publicApi ResponseEntity<ResponseObject> unFollowComment(@PathVariable UUID commentId) {
